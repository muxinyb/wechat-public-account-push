export const config = {
  ...
  // 如果你非要填这里也行。脚本也能运行
  APP_ID: "wxde203a4510aa798d",

  // 公众号APP_SECRET
  // 建议不要填这里，请使用文档中github secret的方法进行保密配置，保护您的隐私安全。
  // 如果你非要填这里也行。脚本也能运行
  APP_SECRET: "545c5f3390bfdd180515e5d6c5b15877",
  ...
  USERS: [
    {
      ...
      id: "omLZI62rx_PZ-U3BKZOHXuWPYZqw",
      // 你想对他发送的模板消息的模板ID
      useTemplateId: "jNZ3ko91zxUJKUZhdiIdumth-fTEGQMetZ71B3DmD40",
      // 所在省份
      province: "贵州",
      // 所在城市
      city: "贵阳",
      ...
      festivals: [
        ...
        {"type": "*生日", "name": "周周", "year": "2000", "date": "05-21"},
      ...
      customizedDateList: [
        ...
        //生日
        {"keyword": "birthday_left", date: "2023-05-21"},
        //在一起的日子
  ...
  CALLBACK_TEMPLATE_ID: "sAvhzreX5URWVhXSKPxVqMCnv-225ovgmmQLGm3KcjE",
  ...
  FESTIVALS: [
    // 注意：此条配置日期为阴历日期，因为`type`中 “生日” 之前有 * 符号
    {"type": "*生日", "name": "老婆", "year": "2020", "date": "09-09", isShowAge: true},
